...
```mermaid
flowchart TD
    subgraph T1["🔍 TRACK 1 — Investigative Research"]
        A1["📚 Literature Review\n(Secondary — completed)"]
        A2["📱 App Audit\n(8 tools evaluated)"]
        A3["🗣️ Semi-Structured Interviews\n(6–8 participants · 45–60 min)"]
        A4["📔 Autoethnographic Diary\n(4 weeks · self-conducted)"]
        A1 --> A2 --> A3 --> A4
    end

    subgraph T2["✏️ TRACK 2 — Generative Design Research"]
        B1["🌐 Scenario Building\n(3 × 2035 futures)"]
        B2["🎨 Speculative Prototyping\n(3–5 artefacts)"]
        B3["🤝 Participatory Critique\n(with interviewees, round 2)"]
        B1 --> B2 --> B3
    end

    T1 <-->|"↔ Continuous Cross-Pollination\nFindings inform design directions"| T2

    OUT["🎯 DESIGN OUTPUT\nMulti-dimensional Dietary Wellbeing Framework\n+ Speculative Artefacts + 3 Scenarios"]
    T1 --> OUT
    T2 --> OUT

    style T1 fill:#edf2f7,stroke:#2c5282,color:#1a1a1a
    style T2 fill:#fff5f5,stroke:#c53030,color:#1a1a1a
    style OUT fill:#f0fff4,stroke:#2f855a,color:#1a1a1a,font-weight:bold
```
...
gantt
    ...
    section Track 2
    Scenario Building  :scen, 2026-05, 2026-07
    Speculative Proto  :proto, 2026-05, 2026-06
    Participatory Crit :crit, 2026-06, 2026-07

    section Submission
    Framework Dev      :frame, 2026-06, 2026-07
    Final Report       :report, 2026-07, 2026-08
    Exhibition         :exh, 2026-07, 2026-08
```
...
*All references formatted in Harvard style. Listed alphabetically by first author's surname.*
...
Damasio, A.R. (2003) *Looking for Spinoza: Joy, Sorrow, and the Feeling Brain*. London: Heinemann. [Somatic marker hypothesis: interoceptive signals as feedback anchors for decision-making.]
...
Glenn, J.C. (1971) *Futurizing Teaching vs. Futures Courses*. Washington, DC: Futures Research Clearinghouse. [Source of the Futures Wheel methodology.]
...
Inayatullah, S. (2008) 'Six Pillars: Futures Techniques Transforming Your Practice', *Foresight*, 10(1), pp. 4–21. [Source of the Futures Triangle framework: Pull / Push / Weight.]
...
*End of IRP Proposal — Weijie Li · Global Innovation Design · Royal College of Art · April 2026*