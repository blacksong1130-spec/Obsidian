...
updated: ==2026-04-12==
changes: ==Cleaned scaffolding and updated versioning based on AI iteration.==
---

> [!tip] 版本说明 Version Notes
> ==**v3 — April 12, 2026** | Scaffolding removed and versioning mechanics updated. Changes made by AI are highlighted in yellow.==
> ==**v3 — 2026年4月12日** | 移除了脚手架内容并更新了版本机制。由 AI 修改的内容以黄色高亮标注。==
...
> **v2 — 2026年4月8日** | 双语版（英文+中文）· 来自导师反馈的修改内容以黄色高亮标注 · 第4、5节新增Mermaid图表
>
